...
//glfwSetErrorCallback(glfw_error_callback);
    ...
    GLFWwindow *window = glfwCreateWindow(1280, 900, "Dear ImGui GLFW+OpenGL3 example", nullptr, nullptr);
    if (window == nullptr)
        return 1;
...
#endif
    {
        ...
        {
          ImGui::Begin("ImSpinner demo " ICON_FA_WIFI);                    // Create a window called "Hello, world!" // and append into it.
